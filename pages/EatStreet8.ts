...
export class EatStreet8 {
  ...
  constructor(page: Page) {
    ...
    this.applyNowLink = page.locator('//a[@class="how-it-works_link"][.//text()[contains(.,"Apply Now")]]');
  ...
  async step2_clickApplyNowAndCheckURL() {
    await this.applyNowLink.click();
    await expect(this.page).toHaveURL('https://eatstreet.com/careers');
  }
